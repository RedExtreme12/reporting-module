(function() {
  ...
  dateRegExp = /^(?:(?:31(\/|-|\.)(?:0?[13578]|1[02]))\1|(?:(?:29|30)(\/|-|\.)(?:0?[13-9]|1[0-2])\2))(?:(?:1[6-9]|[2-9]\d)?\d{2})$|^(?:29(\/|-|\.)0?2\3(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\d|2[0-8])(\/|-|\.)(?:(?:0?[1-9])|(?:1[0-2]))\4(?:(?:1[6-9]|[2-9]\d)?\d{2})$/;
  ...
  sortable.setupTypes([
    {
      ...
      match: function(a) {
        console.log('hello!');
        // console.log(a.match(dateRegExp));
        return a.match(dateRegExp);
      },
      comparator: function(a) {

        var parts = a.split(".");
        return new Date(parts[2], parts[1] - 1, parts[0]) || 0;
      }
    }, {
      name: 'alpha',
      defaultSortDirection: 'ascending',
